...
export default function Signup() {
  ...
  return (
    <div style={{ backgroundImage: 'url("https://img.freepik.com/premium-photo/asian-food-ingredients-spices-black-stone-table-flat-lay-with-copy-space_1093939-50063.jpg?w=996")', backgroundSize: 'cover',height: '105vh' }}>
      <div>
      <Navbar />
      </div>
